...
train_dataset = PneumoniaMNIST(split="train", download=True)  #Splits training and testing data
...
y_train = to_categorical(y_train, num_classes=2)  #one hot encodes labels
y_test = to_categorical(y_test, num_classes=2)


architecture = [784, 128, 64, 32, 2] 
